...
const POSTERS = [
    { id: 1, src: img1, color: "from-red-600" },
    { id: 2, src: img2, color: "from-blue-600" },
    { id: 3, src: img3, color: "from-green-600" },
    { id: 4, src: img4, color: "from-orange-600" },
    { id: 5, src: img5, color: "from-purple-600" },
];
                    ...
                    >
                       {/*} <div className="flex items-center justify-center lg:justify-start gap-3 mb-4">
                        ...
                        <p className="mt-6 text-neutral-400 text-lg max-w-md leading-relaxed lg:border-l lg:border-neutral-800 lg:pl-6 mx-auto lg:mx-0">
                            A curated collection of our journey. <br/>
